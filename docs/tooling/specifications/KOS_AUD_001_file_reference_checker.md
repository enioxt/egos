...
5.  **Report Generation**: Compile results into JSON and Markdown formats.
          ...
          "files_analyzed": [
            {
              ...
              "referenced_by": [
                ...
                {"source_file": "docs_egos/api/module_a.md", "line_number": 5, "context": "Details about module_a.py"}
              ]
            },
            {
    ...
    -   **Markdown Report**: Human-readable summary.
        ...
        - Found in `docs_egos/api/module_a.md:5` (Context: `Details about module_a.py`)
        ---
        ```
...
excluded_directories:
  ...
  - "temp"
  - "tmp"
  - "docs_egos/_build" # Sphinx builds
