...
| docs\reports\backups\backup_20250521_110900\docs_egos\06_guides_and_tutorials | 18 | 133 |
...
| docs\reports\backups\backup_20250521_110900\docs_egos\zz_archive\legacy_root_backups\docs\20250513_181517\docs\governance\migrations | 1 | 58 |
...
| docs\reports\backups\backup_20250521_110900\docs_egos\zz_archive\legacy_root_backups\docs\20250513_181701\docs\subsystems | 7 | 33 |
...
| docs\reports\backups\backup_20250521_110900\docs_egos\zz_archive\legacy_root_backups\docs\20250513_181529\docs\governance\migrations\processed\mixed-en-pt | 8 | 25 |
...
| docs\reports\backups\backup_20250521_110900\website | 1 | 19 |
...
| docs\reports\backups\backup_20250521_110900\docs_egos\zz_archive\legacy_root_backups\docs\20250513_181555\docs\governance\roadmaps\MYCELIUM | 1 | 14 |
...
| docs_egos\06_community_contribution | 1 | 8 |
...
| docs\reports\backups\backup_20250521_110900\docs_egos\zz_archive\legacy_root_backups\docs\20250513_181631\docs\markdown\subsystems\TRUST_WEAVER | 1 | 7 |
...
| docs_egos\03_subsystems\KOIOS\chronicler_module | 1 | 5 |
...
| docs\reports\backups\backup_20250521_110900\research | 1 | 4 |
...
| docs\reports\backups\backup_20250521_110900\docs_egos\zz_archive\legacy_root_backups\docs\20250513_181555\docs\governance\roadmaps\STRAT | 1 | 3 |
...
| docs_egos\03_processes\maintenance | 1 | 3 |
...
| docs_egos\01_subsystems\KOIOS | 1 | 2 |
...
| docs\technical\code_practices\code_analysis_archive | 1 | 1 |
...
| scripts | 1 | 1 |
| scripts\cross_reference\docs\reports | 1 | 1 |
...
| docs\reports\temp_grep_results\grep_RelativePathSelf_results.json | 1234 | 
  {
    ...
    "LineNumber": 22,
    "LineContent": "EGOS is founded upon the principles outlined in the **[Master Quantum Prompt (MQP) -> ./docs/reference/MQP.md<br>ROADMAP.md -> mdc:../../ROADMAP.md<br>Installation steps in the main project README.md -> ../../README.md#installation<br>...and 1231 more |
...
|---------------|-------------|------------|
| Target file does not exist | 22640 | 95.2% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'docs\\reports\\temp_grep_results\\cci:7:\\file:\\C:\\EGOS\\.cursor\\rules\\subsystem_boundaries.mdc:0:0-0:0' | 19 | 0.1% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'apps\\dashboard\\mdc:.\\diagnostic_tracking.py' | 9 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'apps\\dashboard\\mdc:.\\diagnostic_visualization.py' | 8 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'docs_egos\\09_project_meta\\reports\\mdc:..\\analysis\\simple_cross_ref_visualizer.py' | 7 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'docs\\reports\\temp_grep_results\\cci:7:\\file:\\c:\\EGOS\\docs\\concepts\\mai%C3%AAutic_interaction.md:0:0-0:0' | 6 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'apps\\dashboard\\mdc:.\\diagnostic_mycelium.py' | 5 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'docs\\core_materials\\historical_changelogs\\.+?' | 5 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'docs\\governance\\.+?' | 5 | 0.0% |
| [WinError 123] A sintaxe do nome do arquivo, do nome do diretório ou do rótulo do volume está incorreta: 'docs\\prompts\\.+?' | 5 | 0.0% |
