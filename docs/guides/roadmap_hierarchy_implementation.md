...
graph TD
    ...
    A --> C[Docs Roadmap<br/>docs_egos/roadmap.md]
...
- <!-- TO_BE_REPLACED -->: Synchronization tool
- <!-- TO_BE_REPLACED -->: Automation setup

### Templates

- <!-- TO_BE_REPLACED -->: Template for main roadmap
- <!-- TO_BE_REPLACED -->: Template for local roadmaps

### Documentation

- <!-- TO_BE_REPLACED -->: Hierarchy guidelines
- <!-- TO_BE_REPLACED -->: Standardization guidelines
