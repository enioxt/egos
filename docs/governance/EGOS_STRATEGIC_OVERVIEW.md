...
depends_on:
  - docs_egos/processes/reorganization/cross_reference_standard.md
  - ROADMAP.md
related_to:
  - docs_egos/processes/reorganization/2025_05_REORGANIZATION.md
  - docs_egos/processes/reorganization/directory_mapping.md
---
...
- **/docs**: All documentation, organized by subsystem and documentation type
  - `/docs_egos/subsystems/[SUBSYSTEM_NAME]`: Documentation for specific subsystems
  - `/docs_egos/core`: Core system documentation
  - `/docs_egos/processes`: Process-related documentation
  - `/docs_egos/templates`: Templates for creating new documentation
