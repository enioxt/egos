...
**Core Dependencies:** `ROADMAP.md`, `docs_egos/website/DESIGN_GUIDE.md`
**Date:** 2025-04-09
...
* `[DONE]` **Task WD-2:** Document Design Directives (Initial draft created in `docs_egos/website/DESIGN_GUIDE.md`).
