...
Task skeletons should be stored in `docs_egos/tasks/skeletons/` with the naming convention `TASKID_taskname_skeleton.md`.
...
python scripts/maintenance/docs_egos/find_references.py --target subsystems/ETHIK/core/validator.py

# Suggest potential references for a file
python scripts/maintenance/docs_egos/suggest_references.py --file subsystems/NEXUS/core/analyzer.py

# Validate references in a file
python scripts/maintenance/docs_egos/validate_references.py --file docs_egos/subsystems/KOIOS/ARCHITECTURE.md
```
...
1. Templates in `docs_egos/templates/`
