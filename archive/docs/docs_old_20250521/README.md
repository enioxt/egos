...
*Navigation Tip:* Use this README as the primary entry point to explore EGOS documentation. Refer back to the main project <!-- TO_BE_REPLACED --> for the overall project overview, installation, and contribution guidelines.
