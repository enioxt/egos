...
- The specific list of mandatory items is defined within the script (e.g., `README.md`, `src/`, `tests/`, `config/`, `docs_egos/`, etc. - *confirm exact list from script implementation*).
...
│   └── default_config.yaml
├── docs_egos/                 # Detailed documentation for EXAMPLE
│   └── architecture.md
