...
*   Insights generated here often inform the main project **<!-- TO_BE_REPLACED -->**.
*   Specific actionable tasks derived from these analyses are added to the **<!-- TO_BE_REPLACED -->**.
*   The process for conducting strategic analysis using AI is guided by **<!-- TO_BE_REPLACED -->**.

---

*Refer to the main project <!-- TO_BE_REPLACED --> for the overall project context.*
