...
1. **Geração de Inventário por Diretório**
   ...
   python scripts/legacy_migration/create_legacy_inventory.py --root "strategic-thinking" --output docs_egos/legacy/strategic_thinking_inventory.md --max-files 5000 --log-file legacy_scan.log --verbose --batch-size 500
   
   python scripts/legacy_migration/create_legacy_inventory.py --root "research" --output docs_egos/legacy/research_inventory.md --max-files 5000 --log-file legacy_scan_research.log --verbose --batch-size 500
   
   python scripts/legacy_migration/create_legacy_inventory.py --root "backups" --output docs_egos/legacy/backups_inventory.md --max-files 5000 --log-file legacy_scan_backups.log --verbose --batch-size 500
   ```

2. **Análise de Resultados**
   - Revisar os relatórios gerados em `docs_egos/legacy/`
...
2. **Documentação das Alterações**
   ...
   python scripts/legacy_migration/create_legacy_inventory.py --root "." --output docs_egos/legacy/post_cleanup_inventory.md --max-files 10000 --log-file post_cleanup.log --verbose
   ```
...
- [Documentação do CRONOS - Backup e Restauração](file:///c:/EGOS/docs_egos/subsystems/CRONOS/backup_restore.md)
- [Princípios EGOS - Compassionate Temporality](file:///c:/EGOS/docs_egos/principles/compassionate_temporality.md)
