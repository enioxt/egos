#!/usr/bin/env python
# -*- coding: utf-8 -*-
# EGOS System - ATRiAN Module: Mock Windsurf API Server
# Version: 0.1.0
# Last Modified: 2025-05-27
#
# Purpose:
# This module provides a simple mock API server that simulates the Windsurf API
# endpoints for testing the WindsurfAPIBackend. This allows for verifying the
# WindsurfAPIBackend integration without requiring the actual Windsurf API service.
#
# MQP Alignment:
# - Conscious Modularity (CM): Isolated testing component
# - Evolutionary Preservation (EP): Enables verification of integration
# - Systemic Cartography (SC): Maps API interaction patterns
#
# Cross-references:
