...
depends_on:
  - docs_egos/core/principles/cross_reference_guidelines.md
related_to:
...
depends_on:
  - docs_egos/core/principles/development_standards.md
related_to:
  - docs_egos/processes/quality/quality_gates.md
---
```
...
depends_on:
  - docs_egos/core/principles/architectural_principles.md
related_to:
  - docs_egos/subsystems/KOIOS/api_reference.md
---
```
