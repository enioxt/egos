...
*Primary Locations: `docs/`, `scripts/documentation/` (if present - not explicitly listed but implied by KOIOS standards)*
...
*   **Recommended Script Development:**
    *   **Directory Comparison Tool:** Create or adapt a script to visually highlight structural differences between repositories.
    *   **File Change Classifier:** Develop a tool to batch-process changed files and suggest categorizations.
    *   **Migration Path Tracker:** Build a utility to record and verify the movement of files during restructuring.
