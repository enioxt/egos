...
<!-- TO_BE_REPLACED -->KOIOS-DOC-011, docs_egos/templates/subsystem_roadmap_template.md
@references:
- Core References:
...
- Standards:
  - <!-- TO_BE_REPLACED --> - File size and modularity standards
---
...
2. **Standardize Subsystem Roadmap Template**
   - Create comprehensive template in `docs_egos/templates/subsystem_roadmap_template.md`
...
Each subsystem roadmap should follow the template defined in `docs_egos/templates/subsystem_roadmap_template.md`, which includes:
