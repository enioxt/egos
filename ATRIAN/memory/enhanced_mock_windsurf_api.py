#!/usr/bin/env python
# -*- coding: utf-8 -*-
# EGOS System - ATRiAN Module: Enhanced Mock Windsurf API Server
# Version: 0.2.0
# Last Modified: 2025-05-27
#
# Purpose:
# This module provides an enhanced mock API server that simulates the Windsurf API
# endpoints for testing the WindsurfAPIBackend. It includes capabilities for
# error simulation, latency injection, and configuration management via api_config.yaml.
#
# MQP Alignment:
# - Conscious Modularity (CM): Isolated testing component with configurable behavior.
# - Evolutionary Preservation (EP): Enables robust verification of integration under various conditions.
# - Systemic Cartography (SC): Maps API interaction patterns and potential failure modes.
#
# Cross-references:
