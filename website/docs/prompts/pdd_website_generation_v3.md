...
metadata:
  ...
  owner: CORUJA / KOIOS
  related_files:
    - docs_egos/research/WebSite Enio Grok e Gemini.txt
    - docs_egos/website/index.html # Target output
    - docs_egos/website/css/style.css # Target output
    - docs_egos/website/js/script.js # Target output
...
*   **Implicit Context:**
    *   Access to the details within the "Website Design Concept for the EGOS Project Integrated with LLMs" report (`docs_egos/research/WebSite Enio Grok e Gemini.txt`), including trends, examples, tables (especially Table 2 for subsystem content).
