...
```bash
python scripts/sync_docs.py --create-template user_guide docs_egos/my_feature/user_guide.md
```
...
python scripts/sync_docs.py --check --files docs_egos/my_feature/document.md
...
```bash
python scripts/fix_documentation_linting.py --specific-file docs_egos/my_feature/document.md
```
...
```bash
python scripts/metrics/documentation_metrics.py --network docs_egos/network_visualization.html
```
...
python scripts/migrate_legacy_docs.py --files docs_egos/legacy_document.md

# Migrate with auto-fix
python scripts/migrate_legacy_docs.py --files docs_egos/legacy_document.md --force
```
