...
metadata:
  ...
  related_files:
    - ROADMAP.md
    - docs_egos/MQP.md
    - docs_egos/research/CONTENT_AGGREGATOR_DEEP_DIVE.md
  required: false
  review_status: draft
...
*   **Core Philosophy:** Touch upon the foundational principles (reference `docs_egos/MQP.md` - ethics, love, universality, fluidity, etc.). Explain *why* these matter for building better systems and fostering better development practices.
...
*   **Modular Design:** Explain the subsystem architecture (ATLAS, NEXUS, KOIOS, CRONOS, ETHIK, Mycelium, etc.). Use a simplified diagram (like the Mermaid chart in `docs_egos/MQP.md`).
