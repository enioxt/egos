...
- Core References:
  ...
  - <!-- TO_BE_REPLACED --> - Main Project roadmap and planning
- Subsystem:
  - <!-- TO_BE_REPLACED --> - KOIOS Roadmap
  - <!-- TO_BE_REPLACED --> - KOIOS Standards
- <!-- TO_BE_REPLACED -->  - <!-- TO_BE_REPLACED --> - Documentation Migration Plan
---
...
Examples:
- `<!-- TO_BE_REPLACED -->` - Reference to the Master Quantum Prompt from a subsystem document
- `<!-- TO_BE_REPLACED -->` - Reference to the KOIOS architecture from a guide
...
A visual representation of the documentation structure is maintained in the `docs_egos/diagrams/documentation_structure.svg` file. This diagram is updated whenever the structure changes.

## References

- <!-- TO_BE_REPLACED --> - Documentation Migration Plan
- <!-- TO_BE_REPLACED --> - KOIOS Standards
- <!-- TO_BE_REPLACED --> - Legacy Documentation Structure Reference
