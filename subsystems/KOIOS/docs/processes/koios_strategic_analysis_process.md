...
@references:
- Core References:
  - [MQP.md](mdc:../../../docs_egos/core_materials/MQP.md) <!-- EGOS-REF-EE1AC943 -->P.md) <!-- EGOS-REF-39FD2382 --> - Master Quantum Prompt defining EGOS principles
  - [ROADMAP.[STRATEGY.md](mdc:../../../docs_egos/STRATEGY.md) <!-- EGOS-REF-5008A77C -->](mdc:../../../docs_egos/STRATEGY.md) <!-- EGOS-REF-85CD5F9A -->](mdc:../../../docs/STRATEGY.md) - Core EGOS Strategy Document
  - <!-- TO_BE_REPLACED --> - Index of all KOIOS processes
- Specific Dependencies:
  ...
  - <!-- TO_BE_REPLACED --> - For goal setting
  - <!-- TO_BE_REPLACED --> - For feasibility/dependency analysis
---
...
*   Making cri[`STRATEGY.md`](mdc:../../../docs_egos/STRATEGY.md) <!-- EGOS-REF-57D25FC4[`MQP.md`](mdc:../../../docs_egos/core_materials/MQP.md) <!-- EGOS-REF-BC311BFB -->docs_egos/STRATEGY.md) <!-- EGOS-REF-2C365CB3[`MQP.md`](mdc:../../../docs_egos/core_materials/MQP.md) <!-- EGOS-REF-FE0F80E2 -->docs/STRATEGY.md)) or Master Quantum Prompt ([`MQP.md`](mdc:../../../docs/core_materials/MQP.md)).
...
1.  **Context Preparation:**
    ...
    *   Gather all relevant background information, existing documents, research findings (e.g., from <!-- TO_BE_REPLACED --> or <!-- TO_BE_REPLACED -->).
...
4.  **Output Storage & Interlinking:**
    ...
    *   **Mandatory:** Within the analysis document, include explicit Markdown links:
        *   Back to the specific version of the me[LLM/IDE Study](mdc:../../../docs_egos/research/Integração_LLM_em_IDEs_.txt) <!-- EGOS-REF-A7531909 -->(mdc:../../../STRATEGIC_THINKING/meta_prompts/strategic_a[LLM/IDE Study](mdc:../../../docs_egos/research/Integração_LLM_em_IDEs_.txt) <!-- EGOS-REF-7029C9E9 -->esearch papers used as context (e.g., `Context Based On: [LLM/IDE Study](mdc:../../../docs/research/Integração_LLM_em_IDEs_.txt)`).
