...
- Core Documents:
  - [MQP](..\reference\MQP.md) - Master Quantum Prompt defining EGOS principles
  - <!-- TO_BE_REPLACED --> - Project overview and introduction
- Community Guidelines:
  - [CODE_OF_CONDUCT](CODE_OF_CONDUCT.md) - Code of conduct
  - <!-- TO_BE_REPLACED --> - Community engagement processes
- Development Workflow:
  - <!-- TO_BE_REPLACED --> - Development workflow
  - <!-- TO_BE_REPLACED --> - Code review guidelines
...
feat/roadmap-updates
3.  **Set Up Environment:** Follow the <!-- TO_BE_REPLACED -->. Ensure all dependencies are correctly installed.

3. **Set Up Environment:** Follow the [Installation steps in the README](README.md) <!-- EGOS-REF-F4677777 -->.
main
...
feat/roadmap-updates
6. **Follow Standards:** Adhere to the **KOIOS** standards for code style, naming, logging, error handling, and documentation. Refer to the primary <!-- TO_BE_REPLACED --> and specific rules in `.cursor/rules/` or `docs/core_materials/standards/`. **When creating or modifying core AI prompts, document them using the <!-- TO_BE_REPLACED -->.**

6. **Follow Standards:** Adhere to the KOIOS standards for code style, naming, logging, and error handling. Refer to relevant `.mdc` rules or documentation in `docs/STANDARDS_*.md`. **When creating or modifying core AI prompts, document them using the <!-- TO_BE_REPLACED -->.**
main
...
- **Follow Guidelines:** Adhere strictly to the <!-- TO_BE_REPLACED -->.
...
- **Handover Standards:** Use the <!-- TO_BE_REPLACED --> when transferring context between sessions or agents.
...
To ensure your local changes are correctly synchronized with the `main` branch on GitHub, follow these steps **in order**. For standard commits of completed work, refer specifically to procedure **<!-- TO_BE_REPLACED -->** in the <!-- TO_BE_REPLACED -->.
...
2. **Synchronize with Remote (`git pull`):**
    ...
    - **Important:** For detailed procedures on handling merge conflicts and other Git challenges, refer to the <!-- TO_BE_REPLACED --> (Procedures <!-- TO_BE_REPLACED --> and <!-- TO_BE_REPLACED -->).
...
4. **Commit Locally (`git commit`):**
    ...
    - **Important:** Use clear commit messages following the [Conventional Commits](https://www.conventionalcommits.org/) standard (e.g., `feat:`, `fix:`, `docs:`, `style:`, `refactor:`, `test:`, `chore:`). Refer to the `commit_messages.mdc` rule and **<!-- TO_BE_REPLACED -->**.
