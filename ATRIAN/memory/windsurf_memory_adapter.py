# EGOS System - ATRiAN Module: Windsurf Memory Adapter
# Version: 1.0
# Last Modified: 2025-05-27
#
# Purpose:
# This module provides a memory adapter for integrating ATRiAN components with
# the Windsurf IDE's memory system. It enables trust score persistence, operation
# history storage, privacy-aware memory management, and context relevance scoring.
#
# MQP Alignment:
# - Compassionate Temporality (CT): Implements time-based trust decay
# - Sacred Privacy (SP): Ensures privacy-aware memory operations
# - Evolutionary Preservation (EP): Maintains state across sessions
# - Reciprocal Trust (RT): Stores and retrieves trust relationships
#
# Cross-references:
