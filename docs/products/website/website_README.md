...
This project uses [`next/font`](https://nextjs.org/docs_egos/app/building-your-application/optimizing/fonts) to automatically optimize and load [Geist](https://vercel.com/font), a new font family for Vercel.
...
Check out our [Next.js deployment documentation](https://nextjs.org/docs_egos/app/building-your-application/deploying) for more details.
