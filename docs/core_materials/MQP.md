...
4.  **Compatibility (HARMONY):**
    ...
    *   Use Windows PowerShell syntax for commands executed via integrated terminals or scripts ([`docs_egos/reference/windows_powershell_commands.md`](mdc:../reference/windows_powershell_commands.md)).
...
7.  **Source of Truth:**
    *   This document ([MQP.md](cci:7://file:///c:/EGOS/docs_egos/core_materials/MQP.md:0:0-0:0)) provides the highest-level directives.
...
*   **Conscious Modularity:** Deep understanding of parts and whole (<!-- TO_BE_REPLACED -->[[subsystem_boundaries.mdc](cci:7://file:///C:/EGOS/.cursor/rules/subsystem_boundaries.mdc:0:0-0:0)](mdc:../../.cursor/rules/subsystem_boundaries.mdc), [`file_modularity.mdc`](mdc:../../.cursor/rules/file_modularity.mdc)).
...
*   **MYCELIUM:** Inter-subsystem communication network (NATS-based), message queuing, event distribution (<!-- TO_BE_REPLACED -->[[subsystem_boundaries.mdc](cci:7://file:///C:/EGOS/.cursor/rules/subsystem_boundaries.mdc:0:0-0:0)](mdc:../../.cursor/rules/subsystem_boundaries.mdc), [`api_design_contracts.mdc`](mdc:../../.cursor/rules/api_design_contracts.mdc)).
