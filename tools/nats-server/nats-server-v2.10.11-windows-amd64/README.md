@references:
  - tools/nats-server/nats-server-v2.10.11-windows-amd64/README.md
...
[Release-Url]: https://github.com/nats-io/nats-server/releases/tag/v2.10.11
[Release-image]: https://img.shields.io/badge/release-v2.10.11-1eb0fc.svg
...
@references(level=1):
  - tools/nats-server/nats-server-v2.10.11-windows-amd64/CONTRIBUTING.md