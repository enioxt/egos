...
*   **`docs/` Directory:** Intended as the central hub for all project documentation. Current reorganization efforts are underway to streamline this directory (<!-- TO_BE_REPLACED -->`diagnosticoENIO.md`, `DOCS_DIRECTORY_DIAGNOSTIC_*.md`).
