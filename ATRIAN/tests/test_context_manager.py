# EGOS System - ATRiAN Module: Test Context Manager
# Version: 1.0
# Last Modified: {{ CURRENT_DATE_TIME_ISO }}
# 
# Purpose:
# This module contains unit tests for the ContextManager class located in
# context_manager.py. It aims to ensure the reliability and correctness
# of context management functionalities within the ATRiAN subsystem.
# 
# Test Coverage:
# - Initialization of ContextManager.
# - Setting, getting, and clearing active contexts.
# - Adding, getting, removing, and clearing passive contexts.
# - Handling of sensitivity tags and additional metadata.
# - Error handling for invalid inputs and edge cases.
# 
# MQP Alignment:
# - Ensures robustness and reliability, indirectly supporting all MQP principles
#   by ensuring a foundational component works as expected.
# - Upholds Integrated Ethics (IE/ETHIK) by verifying components that manage potentially sensitive data.
# 
# Cross-references:
