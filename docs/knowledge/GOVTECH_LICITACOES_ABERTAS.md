...
### Modelos de estruturação possíveis
...
Remuneração definida em contrato de subcontratação
...
Papéis e responsabilidades definidos por MOU
...
[ ][ ] Preparar deck de parceria (1 página): nossa stack + modelo de estruturação proposto
