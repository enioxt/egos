...
@references:
- <!-- TO_BE_REPLACED -->
- <!-- TO_BE_REPLACED --> - Explicação opcional
```
...
@references:
- <!-- TO_BE_REPLACED -->
- <!-- TO_BE_REPLACED --> - Core directive document
...
@references:
- <!-- TO_BE_REPLACED -->
- <!-- TO_BE_REPLACED --> - Utility functions
- <!-- TO_BE_REPLACED --> - Configuration file
"""
```
...
- <!-- TO_BE_REPLACED -->` no início do documento (após o cabeçalho YAML em arquivos Markdown)
...
1. **Seja Específico**:
   - ❌ `<!-- TO_BE_REPLACED --> - Utilities`
   - ✅ `<!-- TO_BE_REPLACED --> - Date formatting and validation functions`

2. **Explique a Relação**:
   - ❌ `<!-- TO_BE_REPLACED -->`
   - ✅ `<!-- TO_BE_REPLACED --> - Configuration for this module's logging levels`
...
- <!-- TO_BE_REPLACED -->
- Core Documents:
  - <!-- TO_BE_REPLACED --> - Princípios fundamentais do EGOS
  - <!-- TO_BE_REPLACED --> - Planejamento e evolução do sistema
- Related Subsystems:
  - <!-- TO_BE_REPLACED --> - Integração com preservação temporal
  - <!-- TO_BE_REPLACED --> - Validação ética de documentação
- Implementation:
  - <!-- TO_BE_REPLACED --> - Logger específico para KOIOS
  - <!-- TO_BE_REPLACED --> - Validação de padrões
---
...
- <!-- TO_BE_REPLACED -->
- Core Documents:
  - <!-- TO_BE_REPLACED --> - Standards definition
  - <!-- TO_BE_REPLACED --> - Core principles
- Related Modules:
  - <!-- TO_BE_REPLACED --> - Logging utilities
  - <!-- TO_BE_REPLACED --> - Markdown parsing
- Configuration:
  - <!-- TO_BE_REPLACED --> - Validation rules
"""
...
- <!-- TO_BE_REPLACED -->`
   - Os links devem usar o formato `<!-- TO_BE_REPLACED -->`
...
3. **Verifique a Sintaxe**:
   - Certifique-se de que a sintaxe `<!-- TO_BE_REPLACED -->` está correta
