...
feat/roadmap-updates
6. **Follow Standards:** Adhere to the **KOIOS** standards for code style, naming, logging, error handling, and documentation. Refer to the primary <!-- TO_BE_REPLACED --> and specific rules in `.cursor/rules/` or `docs_egos/core_materials/standards/`. **When creating or modifying core AI prompts, document them using the <!-- TO_BE_REPLACED -->.**

6. **Follow Standards:** Adhere to the KOIOS standards for code style, naming, logging, and error handling. Refer to relevant `.mdc` rules or documentation in `docs_egos/STANDARDS_*.md`. **When creating or modifying core AI prompts, document them using the <!-- TO_BE_REPLACED -->.**
main
