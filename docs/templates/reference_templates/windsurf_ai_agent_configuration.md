...
- Related Documents:
  ...
  - <!-- TO_BE_REPLACED --> - Strategic planning and workflow integration
...
- docs_egos/standards/coding_standards.md
- docs_egos/standards/documentation_standards.md
...
- docs_egos/templates/action_skill_log_template.md
- docs_egos/templates/skill_demonstration_case_study.md
