# EGOS System - ATRiAN Module: Windsurf IDE Adapter
# Version: 1.0
# Last Modified: 2025-05-27
#
# Purpose:
# This module provides a direct integration layer between ATRiAN components and
# the Windsurf IDE. It enables ATRiAN's functionality to be accessed directly
# through Windsurf's global rules system rather than requiring a separate service.
#
# Key Functionalities:
# - Contextual evaluation of Windsurf operations
# - Mapping between Windsurf events and ATRiAN contexts
# - Trust and ethics assessment for IDE activities
# - State persistence through Windsurf memory system
#
# MQP Alignment:
# - Integrated Ethics (IE/ETHIK): Direct ethical assessment of IDE operations
# - Reciprocal Trust (RT): Trust evaluation and boundary enforcement
# - Sacred Privacy (SP): Privacy-aware guidance for sensitive operations
# - Conscious Modularity (CM): Clean integration with existing infrastructure
# - Evolutionary Preservation (EP): Lightweight integration allowing for growth
#
# Cross-references:
