...
* Substantiate analyses and recommendations with logic and, whenever possible, cite observable data or trends (inferred or from provided context/research like `[<!-- TO_BE_REPLACED -->LLM/IDE Study, Sec 7.2]`).
