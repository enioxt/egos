...
2. **Utilize `@` Symbols:** When discussing specific files or folders in chat, use `@` mentions (e.g., `@docs_egos/css/style.css`, `@subsystems/KOIOS/`) to provide direct context to the Agent. Cursor automatically attaches this context.
