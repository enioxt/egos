...
@references:
- Core References:
  - <!-- TO_BE_REPLACED --> - Documentation organization standard
  - <!-- TO_BE_REPLACED --> - Comprehensive documentation index
- <!-- TO_BE_REPLACED -->  - [Human-AI Collaboration Guidelines](human_ai_collaboration_guidelines.md) - Guidelines for human-AI teamwork
...
|----------|----------|----------------|
| Documentation Structure Standard | <!-- TO_BE_REPLACED --> | Creating/editing documentation, reorganizing files, onboarding new team members |
| File Size & Modularity Standard | <!-- TO_BE_REPLACED --> | Creating new code files, refactoring existing code, code reviews |
| Cross-Reference Best Practices | [docs_egos/project_documentation/process/cross_reference_best_practices.md](cross_reference_best_practices.md) | Adding references between documents, creating new documentation |
| Documentation Index | <!-- TO_BE_REPLACED --> | Searching for documentation, onboarding new team members, planning documentation work |
| Universal Migration Framework | <!-- TO_BE_REPLACED --> | Planning migrations or reorganizations, moving files or content |
  ...
  "documentationTriggers": [
    {
      "filePattern": "*.md",
      "suggestDocs": [
        "docs_egos/project_documentation/standards/documentation_structure_standard.md",
        "docs_egos/project_documentation/process/cross_reference_best_practices.md"
      ]
    },
    {
      "filePattern": "*.py",
      "suggestDocs": [
        "docs_egos/project_documentation/guides/standards/file_size_modularity_standard.md"
      ]
    },
    {
      "action": "fileMove",
      "suggestDocs": [
        "docs_egos/project_documentation/governance/migrations/universal_migration_framework.md"
      ]
    }
  ]
}
...
@references:
- Standards:
  - File Size & Modularity Standard (docs_egos/project_documentation/guides/standards/file_size_modularity_standard.md)
"""
```
...
📄 [documentation_structure_standard.md](docs_egos/project_documentation/standards/documentation_structure_standard.md)
...
- Reference the [Documentation Index](docs_egos/DOCUMENTATION_INDEX.md) for a comprehensive list of all documentation
